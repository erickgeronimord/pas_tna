...
# =============================================
# 0. CONFIGURACIÓN DE PÁGINA (DEBE SER LO PRIMERO)
# =============================================
st.set_page_config(
    layout="wide",
...
# =============================================
# 3. EL RESTO DEL DASHBOARD (CONTENIDO PROTEGIDO)
# =============================================
    ...
    if not df_mes.empty:
        ...
        st.dataframe(
            centro_analisis.style.format({
                ...
                'Unidades': "{:,.0f}"
            }).map(color_variacion, subset=['Variación vs Promedio']),   # <--- CORRECCIÓN: applymap -> map
            use_container_width=True,
            height=300
        )
